...
- **[Foundation AI Models](#ehrgenai)** using vast multimodal datasets to accelerate disease discovery.
- **[Decision Support Systems](#mac-copilot)** to scale specialist-level clinical and neuropathological diagnoses.
...
### Decision Support Systems {#mac-copilot}
...
### AI Conversational Agents {#conv-ai}
