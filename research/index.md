...
- **[Foundation Models for health AI](#ehrgenai)** using vast multimodal datasets to accelerate disease discovery.
- **[Clinical Agentic AI](#mac-copilot)** to scale specialist-level clinical and neuropathological diagnoses.
- **[Conversational Agents](#conv-ai)** to conduct clinical assessments, streamlining data collection, monitoring and care.

<div class="container" style="text-align: center;">
<img src="/figures/vision_2.png" alt="Vision" style="width: 55%">
</div>

### Foundation Models for Health AI {#ehrgenai}
